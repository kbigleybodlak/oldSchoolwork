...
//begin program. This is the String version
#include <iostream>
#include <string>
using namespace std;
...
/*
	...
	date.
	date is the string that user input is stored in.
	a and b are used to manipulate chars in the string.
	monthdate is the string used for the final display of the 
	date.
