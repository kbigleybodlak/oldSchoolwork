 ...
 */
public class Csc650projectCBCEnRe {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("test CBC encoder with CBC residue for integrity and confidentiality, please only use hexidecimal values.");
...
public static String Cbc(String m, String key, String IV) throws Exception{
    ...
    //k= numIndexes;
    String cbcResidue ="";
    //***************EXECUTION LOOP. last iteration xors the last ciphertext block with itself.
    for(i=0;i<=numBlocks;i++){
        if(i<numBlocks){
            messagePiece = m.substring(16*i, 16*i+16);
        }else{
            messagePiece = xorElement;
        }
        ...
        //if(i==numBlocks)
        //System.out.println("messageBytes after xor:  " +messageBytes[0]+messageBytes[1]+messageBytes[7]);
    ...
    //System.out.println("cbc Residue: "+xorElement);
   ...
   public static byte[] concat(byte[] a, byte[] b) {
    ...
    public static byte[] hexStringToByteArray(String s){
        ...
        for(i=0; i<byteForDES.length;i++){
            ...
            //adding nibbles to the byte, insert.
            ...
            for(j=1,k=0;j>=0 && k<2;j--,k++){
                ...
                switch(nibble){
                    case '0':
                        //since we initialized insert to 0, we don't need to have any changes.
                        break;
                    case '1':
