/*
 * csc 650 project 1 cfb encryption implementation
 */
package csc650projectcfb;
    ...
    */
    ...
    public static String ofb(String m, String key, String IV, int k) throws Exception{
        ...
        for(i=0;i<numBlocks;i++){
            ...
            xorElement = "";
            ivBytes = encrypto.encrypt(ivBytes);   //autopads it to 128 bits, but only 
            IV = hexToBinaryString(IV);
            ...
            //System.out.println("bitstring from DES:  "+xorElement);
            ...
            subIV = xorElement.substring(0, k);
            xorResult = xorBinaryStrings(subMsg,subIV);  // a string k long that is the xor of upper k bits of plaintext and the IV.
            //System.out.println("bitstring after xor #"+i+": "+xorResult);
            //creating the next IV to be used for encryption.  IV should stay at 64 bits.
            if(IV.length()>k){
                IV = IV +xorResult;
                IV = IV.substring(k, IV.length());//has correct amount.
                //System.out.println("IV after round "+i+":  "+IV);
            ...
            finalString = finalString + xorResult;
